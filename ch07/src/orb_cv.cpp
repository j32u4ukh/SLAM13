...
int main(int argc, char **argv) {
    ...
    // DescriptorExtractor is an abstract class, so you can't instantiate it. 
    // It's just a common interface for descriptor extractors.
    ...
    //-- 第四步:匹配點對篩選
    // 計算最小距離和最大距離
    auto min_max = minmax_element(matches.begin(), 
                                    matches.end(),
